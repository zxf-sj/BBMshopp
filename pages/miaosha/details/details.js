...
Page({
    ...
    onLoad: function(t) {
        o.pageOnLoad(this), console.log(wx.getSystemInfoSync()), n = 0, i = 1, s = !1, r = !0, 
        this.setData({
            store: wx.getStorageSync("store")
        });
        var e = 0, d = t.user_id;
        console.log("options=>" + JSON.stringify(t));
        var c = decodeURIComponent(t.scene);
        if (void 0 != d) e = d; else if (void 0 != c) {
            console.log("scene string=>" + c);
            var u = a.scene_decode(c);
            console.log("scene obj=>" + JSON.stringify(u)), u.uid && u.gid ? (e = u.uid, t.id = u.gid) : e = c;
        }
        o.loginBindParent({
            parent_id: e
        });
